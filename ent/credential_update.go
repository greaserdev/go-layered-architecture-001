...
func (_u *CredentialUpdate) SetPassword(v string) *CredentialUpdate {
	_u.mutation.SetPassword(v)
	return _u
}

// SetNillablePassword sets the "Password" field if the given value is not nil.
func (_u *CredentialUpdate) SetNillablePassword(v *string) *CredentialUpdate {
	if v != nil {
		_u.SetPassword(*v)
	}
	return _u
...
func (_u *CredentialUpdate) SetUserID(id uuid.UUID) *CredentialUpdate {
	_u.mutation.SetUserID(id)
	return _u
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (_u *CredentialUpdate) SetNillableUserID(id *uuid.UUID) *CredentialUpdate {
	if id != nil {
		_u = _u.SetUserID(*id)
	}
	return _u
...
// SetPassword sets the "Password" field.
func (_u *CredentialUpdateOne) SetPassword(v string) *CredentialUpdateOne {
	_u.mutation.SetPassword(v)
	return _u
}

// SetNillablePassword sets the "Password" field if the given value is not nil.
func (_u *CredentialUpdateOne) SetNillablePassword(v *string) *CredentialUpdateOne {
	if v != nil {
		_u.SetPassword(*v)
	}
	return _u
...
// SetUserID sets the "user" edge to the User entity by ID.
func (_u *CredentialUpdateOne) SetUserID(id uuid.UUID) *CredentialUpdateOne {
	_u.mutation.SetUserID(id)
	return _u
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (_u *CredentialUpdateOne) SetNillableUserID(id *uuid.UUID) *CredentialUpdateOne {
	if id != nil {
		_u = _u.SetUserID(*id)
	}
	return _u
